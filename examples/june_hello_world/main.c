...
void /* main */ function_2(long allocation_id);

void /* main */ function_2(long allocation_id){
int64_t /* x */  variable_2 = 10LL;
printf("%lli", /* x */ variable_2);
;
printf("%s\n", "");
;
printf("%li\n", /* x */ variable_2);
;
printf("%s", "Mihir Contributed fo first time .... ");
;
printf("%s\n", "hello");
;
}
int main() {
allocator = create_allocator(100);
function_2(0);
}
